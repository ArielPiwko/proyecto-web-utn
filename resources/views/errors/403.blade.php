...
<div class="box">
 <!-- <div class="box__ghost">
  ...
  <br><br>
  <img src="{{URL::asset('/Imagenes/403.png')}}" alt="404" id="404">
  <div class="box__description-text ups">Ups...</div>

  <div class="box__description">
    <div class="box__description-container">
      <div class="box__description-text">No tienes los permisos para ver esta página</div>
    </div>
